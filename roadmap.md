...
## Tarefas
- [ ] Padronizar todos os botões de ação dos approvals pelo menor tamanho mostrado na captura
- [ ] Exibir a Fila do Supply nos lembretes do app Supply e na Central de Pendências
