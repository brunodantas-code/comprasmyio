...
- [ ] Checklist da OS — Perfil de consumo da loja: permitir seleção múltipla entre vestiários, copas, pias, banheiros e somente bebedouro; classificar automaticamente a loja como consumo baixo, médio ou alto conforme critérios definidos pelo usuário.
