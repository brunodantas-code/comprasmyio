- [ ] Site Survey — concluir cada Loja/LUC separadamente, registrar pendências na etapa 7 e concluir a visita geral apenas após todos os pontos.
- [ ] Site Survey — usar uma lista pesquisável de Loja/LUC com texto editável para facilitar a busca.
