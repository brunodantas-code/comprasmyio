- [ ] Site Survey mobile — organizar os campos de data e hora em Nova Visita, eliminando desalinhamento e sobreposição.
- [ ] Supply e Cash Flow — substituir menus superiores pelo padrão inferior fixo do Site Survey, com submenus ascendentes.
...
- [x] Site Survey — substituir a tag Pendente por contador vermelho sobre o número da etapa, somente após salvar progresso, removendo-o ao concluir a etapa.
...
- [x] Todos os apps — manter a navegação inferior atual e adaptar somente o menu das três linhas no desktop, com apresentação compacta e conteúdo adequado.
...
- [x] Site Survey — remover a divisória abaixo do seletor de modelos e alinhar “Condicionar” e “Gerar ação” abaixo das ações da pergunta, no canto direito.
...
- [x] Site Survey — permitir informar e alterar a ordem numérica das seções do checklist, aplicando essa sequência na execução das visitas.
- [x] Site Survey — substituir a ordem manual de seções e perguntas por blocos arrastáveis, renumerando e salvando a sequência automaticamente.
- [ ] Organizar o preenchimento do Site Survey em sequência cronológica e lógica, agrupando os checkboxes em etapas: 1) Preparação pré-visita — OS cadastrada, contato com o cliente, data/local, previsão do tempo, restrições, celular, powerbank, parafusadeira e ferramentas; 2) Chegada e responsáveis — técnicos myio e acompanhantes da manutenção; 3) Condições e perfil do local — áreas externas, ambientes e perfil de consumo; 4) Água e hidrômetro — acesso, localização, registro, fluxo, vazão, flange, tubulação e saída pulsada; 5) Instalação elétrica — ponto próximo e encaminhamento; 6) Materiais necessários; 7) Revisão, pendências, fotos e encerramento. Exibir uma etapa por vez, preservar o progresso e impedir avanço quando houver resposta, detalhe ou foto obrigatória pendente.
