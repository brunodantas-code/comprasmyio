...
ALTER TABLE public.client_units
  ADD CONSTRAINT client_units_state_valid
...
BEGIN
  ...
  INSERT INTO public.client_units (client_id, name, cnpj, city, state, active, created_by)
  VALUES (_destination_client_id, source_client.name, source_client.cnpj, source_client.city, source_client.state, true, auth.uid())
