...
COMMENT ON FUNCTION public.set_site_survey_number() IS 'Gera obrigatoriamente o número da visita no formato AAAAMMDDXXXX, com sequência diária no fuso de São Paulo.';