...
function QuestionRuleFields({ question, priorQuestions, actions, questionAction, disabled = false }: { question?: Question; priorQuestions: Question[]; actions: SurveyAction[]; questionAction?: QuestionAction; disabled?: boolean }) {
  ...
  return <div className="col-span-full flex flex-col items-start gap-2 sm:col-span-1 sm:col-start-5">
    ...
    {conditioned || generateAction ? <div className="col-span-full grid w-full gap-3 sm:col-span-5 sm:col-start-1 sm:grid-cols-2">
