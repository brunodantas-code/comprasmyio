...
function QuestionRuleFields({ question, priorQuestions, actions, questionAction, disabled = false }: { question?: Question; priorQuestions: Question[]; actions: SurveyAction[]; questionAction?: QuestionAction; disabled?: boolean }) {
  ...
  return <div className="col-span-full grid gap-2 lg:grid-cols-[40px_minmax(220px,1.3fr)_minmax(160px,.7fr)_minmax(200px,1fr)_auto]">
    ...
    {conditioned || generateAction ? <div className="col-span-full grid w-full gap-3 sm:grid-cols-2">
