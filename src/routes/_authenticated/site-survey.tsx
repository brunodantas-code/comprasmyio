  ...
  const pointPendingFields = (form: HTMLFormElement) => {
    ...
    for (const section of pointSections) {
      if (section.title === "Materiais necessários") {
        ...
        const equipmentAnswer = equipmentQuestion ? String(answerParts(formAnswers.get(equipmentQuestion.id)).value ?? "").toLocaleLowerCase("pt-BR") : "";
