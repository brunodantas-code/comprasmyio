...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Myio Supply — Gestão de Materiais" },
      { name: "description", content: "Plataforma Myio Supply para solicitações de compra, controle de estoque e expedição." },
      { property: "og:title", content: "Myio Supply — Gestão de Materiais" },
      { property: "og:description", content: "Plataforma Myio Supply para solicitações de compra, controle de estoque e expedição." },
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('myio-theme');var d=t==='dark'||(!t&&window.matchMedia('(prefers-color-scheme: dark)').matches);document.documentElement.classList.toggle('dark',d);document.documentElement.style.colorScheme=d?'dark':'light'}catch(e){}})();`,
          }}
        />
        <HeadContent />
      </head>
