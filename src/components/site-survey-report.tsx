...
const buildPointSummaries = (responses: ReportResponse[], questions: Question[], sections: Section[]): PointSummary[] => {
  ...
  const location = hydraulicAnswer(["localizacao do hidrometro", "posicao do hidrometro"]);
