...
export function SiteSurveyEnvironmentManager({ visitId, userId, canEdit, onChanged }: { visitId: string; userId: string; canEdit: boolean; onChanged?: () => void }) {
