    ...
    if (isCustomized) {
      ...
      if ((existingPermissionCount ?? 0) === 0) {
        ...
        const menuKeys = definition.base_profile === "admin"
          ? [
              "solicitacoes", "solicitacoes_minhas", "solicitacoes_novas", "solicitacoes_centro_custo",
              "solicitacoes_item_novo", "solicitacoes_alocacao_projeto", "solicitacoes_alocacao_cliente",
